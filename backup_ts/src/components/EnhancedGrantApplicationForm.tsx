            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  className={errors.projectField ? 'border-red-500' : ''}
                  placeholder="e.g., Education, Healthcare, Technology"
                />
                {errors.projectField && (
                  <p className="text-red-500 text-sm mt-1">{errors.projectField.message}</p>
                )}
              </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {errors.projectDuration && (
                    <p className="text-red-500 text-sm mt-1">{errors.projectDuration.message}</p>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  rows={4}
                  {...register('fundingUse')}
                  className={errors.fundingUse ? 'border-red-500' : ''}
                  placeholder="Provide a detailed breakdown of how the grant money will be used..."
                />
                {errors.fundingUse && (
                  <p className="text-red-500 text-sm mt-1">{errors.fundingUse.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  className={errors.expectedImpact ? 'border-red-500' : ''}
              ...
              <div>
                ...
                <Textarea
                  ...
                  className={errors.whyDeserving ? 'border-red-500' : ''}
                  placeholder="Explain why you should be chosen for this grant..."
                />
                {errors.whyDeserving && (
