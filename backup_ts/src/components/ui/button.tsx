  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 group relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg shadow-red-500/25 hover:shadow-xl hover:shadow-red-500/40 hover:scale-105 focus-visible:ring-red-500/50",
        outline:
          "border-2 border-gray-200 bg-white/80 backdrop-blur-md text-gray-700 shadow-sm hover:bg-white hover:border-blue-300 hover:text-blue-700 hover:shadow-md hover:scale-105 focus-visible:ring-blue-500/50",
        secondary:
          "bg-gradient-to-r from-gray-100 to-gray-200 text-gray-700 shadow-sm hover:shadow-md hover:scale-105 hover:from-gray-200 hover:to-gray-300 focus-visible:ring-gray-500/50",
        ghost:
          "text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 hover:scale-105 backdrop-blur-sm",
