...
export async function DELETE(request, { params }) {
    try {
        ...
        // Update the response
        const updatedResponse = await ChatResponse.findByIdAndUpdate(responseId, updateFields, { new: true });
...
export async function POST(request, { params }) {
    try {
        ...
        await ChatMessage.findByIdAndUpdate(deletedResponse.messageId, { $pull: { responses: responseId } });
        return NextResponse.json({
            success: true,
