          ...
          <div className="p-6 border-b">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
              ...
              <div className="flex gap-2">
                <button onClick={() => fetchChats()} className="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-sm">
                  Refresh
                </button>
                <button onClick={deleteAllMessages} className="px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700 transition-colors text-sm">
                  Clear All
                </button>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0">
            ...
            <div className="lg:col-span-1 border-r bg-gray-50 p-4">
              ...
              {filteredChats.length === 0 ? (<div className="text-center py-8 text-gray-500">
                  ...
                  {filteredChats.map((chat) => (<div key={chat._id} onClick={() => setSelectedMessage(chat)} className={`p-3 rounded-lg cursor-pointer transition-all duration-200 ${selectedMessage?._id === chat._id
                    ...
                    : 'bg-white hover:bg-gray-50 border border-gray-200'}`}>
                      ...
                      <div className="flex justify-between items-center text-xs text-gray-500">
                        ...
                        {chat.responses && chat.responses.length > 0 && (<span className="bg-green-100 text-green-600 px-2 py-0.5 rounded-full ml-2">
            ...
            <div className="lg:col-span-2">
              {selectedMessage ? (<div className="flex flex-col h-[600px]">
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                    ...
                    {/* Support Responses */}
                    {selectedMessage.responses && selectedMessage.responses.length > 0 && (selectedMessage.responses.map((response, index) => (<div key={index} className="flex justify-end">
                          <div className="max-w-[70%]">
                ...
                if (e.key === 'Enter' && (e.ctrlKey || e.metaKey)) {
                    ...
                    <div className="flex justify-between items-center mt-3 pt-3 border-t">
                      ...
                      <div className="flex space-x-2">
                        <button onClick={() => deleteMessage(selectedMessage._id)} className="px-3 py-1 bg-red-100 text-red-700 rounded hover:bg-red-200 transition-colors text-xs">
                          Delete
                        </button>
                        <button onClick={() => clearConversation(selectedMessage.sessionId)} className="px-3 py-1 bg-orange-100 text-orange-700 rounded hover:bg-orange-200 transition-colors text-xs">
                          Clear Chat
                        </button>
                      </div>
                    </div>
