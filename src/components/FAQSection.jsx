...
const faqs = [
    ...
    },
    {
        ...
        answer: (<div className="space-y-2">
      ...
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-12">{/* removed animate-fade-up */}
            {Object.entries(categories).map(([key, category]) => (<button key={key} onClick={() => setActiveCategory(key)} className={getCategoryClasses(key)}>
                {category.name}
              </button>))}
          </div>
          ...
          <div className="space-y-4">
            {filteredFAQs.map((faq, index) => (<div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 group" style={{ animationDelay: `${0.2 + index * 0.05}s` }}>
                <button onClick={() => toggleFAQ(index)} className="w-full text-left flex items-center justify-between p-6 hover:bg-gradient-to-r hover:from-gray-50 hover:to-transparent transition-all duration-300">
                ...
                {openFAQ === index && (<div className="px-6 pb-6 animate-scale-in">
          ...
          <div className="mt-12 text-center animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <div className="card">
              <div className="text-center">
                ...
                <a href="mailto:info@impactgrantsolutions.org" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl">
