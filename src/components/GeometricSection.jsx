...
export default function GeometricSection() {
    return (<section className="relative py-24 bg-gradient-to-r from-blue-50 via-white to-red-50 overflow-hidden">
        ...
        <div className="relative h-96 flex items-center justify-center">
          ...
          <div className="absolute right-0 top-0 w-64 h-full">
            <div className="grid grid-cols-8 gap-2 h-full items-center justify-items-center">
              {[...Array(64)].map((_, i) => (<div key={i} className={`rounded-full transition-all duration-500 hover:scale-150 cursor-pointer ${i % 4 === 0 ? 'w-4 h-4 bg-red-500' :
                i % 4 === 1 ? 'w-3 h-3 bg-red-400' :
                    i % 4 === 2 ? 'w-2 h-2 bg-red-300' :
                        'w-1 h-1 bg-red-200'}`} style={{
