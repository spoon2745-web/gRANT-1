...
export default function Hero() {
    return (<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-30">
        ...
        <div className="absolute top-0 right-0 w-96 h-screen">
          <div className="grid grid-cols-12 gap-2 h-full items-center">
            {[...Array(144)].map((_, i) => (<div key={i} className={`w-3 h-3 rounded-full ${i % 3 === 0 ? 'bg-red-500' : i % 3 === 1 ? 'bg-red-400' : 'bg-red-300'} opacity-70`} style={{
